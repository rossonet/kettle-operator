...
@Version("v1")
@ShortNames("kct")
public class CronKettleTransformation extends
		CustomResource<CronKettleTransformationSpec, CronKettleTransformationStatus> implements Namespaced, KettleWork {
